 ...
 * @license MIT
 * THIS IS REALLY FOR THE BRET, NOT THE EARNINGS TASK /*
 */
...
(function(angular){
	 ...
	 * @constructor
	 */
	var BombTaskController_BRET = function($scope,$filter,$interval,$injector)
		{
	 ...
	 */
	BombTaskController_BRET.$inject = ['$scope','$filter','$interval','$injector'];

	/**
	 * Initializes matrix array and random bomb.
	 * @return {Void}
	 */
	BombTaskController_BRET.prototype.init = function()
		{
	...
	/**
	 * Resets BRET for new years.
	 * @return {Void}
	 */
	BombTaskController_BRET.prototype.reset = function()
		{
	...
	/**
	 * Starts current BRET year.
	 * @return {Void}
	 */
	BombTaskController_BRET.prototype.start = function(index)
		{
	...
	/**
	 * Stops current BRET year.
	 * @return {Void}
	 */
	BombTaskController_BRET.prototype.stop = function()
		{
	 ...
	 * @return {Void}
	 */
	BombTaskController_BRET.prototype.resolve = function()
		{
	 ...
	 * @return {Void}
	 */
	BombTaskController_BRET.prototype.update = function(column,active)
		{
	 ...
	 * @return {Void}
	 */
	BombTaskController_BRET.prototype.select = function()
		{
	 ...
	 * @return {Boolean}
	 */
	BombTaskController_BRET.prototype.isBomb = function(column)
		{
	 ...
	 * @return {Integer}
	 */
	BombTaskController_BRET.prototype.hasBomb = function()
		{
			var me = this,
	 ...
	 * @return {Integer}
	 */
	BombTaskController_BRET.prototype.getTotalBoxes = function()
		{
	 ...
	 * @return {Integer}
	 */
	BombTaskController_BRET.prototype.getCollectedBoxes = function()
		{
	 ...
	 * @return {Integer}
	 */
	BombTaskController_BRET.prototype.getRemainingBoxes = function()
		{
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._getConstant = function(name)
		{
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._getColumn = function(data)
		{
			// for data-binding!
			var row = data.row-1,
				col = data.col-1;
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._getState = function()
		{
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._setState = function(data)
		{
			if( typeof sessionStorage !== "undefined" )
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._removeState = function()
		{
			if( typeof sessionStorage !== "undefined" )
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._persist = function()
		{
			var state = {
				bomb: this.bomb,
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._desist = function()
		{
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._initSettings = function()
		{
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._initMembers = function()
		{
			this.collection = [];			
			this.started = false;
			this.stopped = false;
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._initWatches = function()
		{
			var me = this;
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._initMatrix = function()
		{
			this.matrix = [];
			this.iterator = [];
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._initBomb = function()
		{
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._initForm = function()
		{
			this.form = {
				bomb: 0,
		 		boxes_scheme: [],
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._getRandom = function(min,max)
		{
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._pushRandom = function(array,value)
		{
	 ...
	 * @ignore
	 */
	BombTaskController_BRET.prototype._shuffleArray = function(array)
		{
	...
	app.controller('BombTaskController_BRET',BombTaskController_BRET);
